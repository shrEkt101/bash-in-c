...
def _test_single_cd(comment_file_path, student_dir, command_wait=0.05):
...
def _test_nested_cd(comment_file_path, student_dir, command_wait=0.05):
...
def _test_variable_filename(comment_file_path, student_dir, command_wait=0.05):
  comment_file = open(comment_file_path, "a")
