...
# Milestone 4 tests
import tests_builtins_pipes
import tests_bash, tests_bg, tests_signals
...
def test_plan():
  ...
  comment_file.write(datetime.datetime.now().strftime("%d-%B-%Y %H:%M:%S") + f"--- Tests Passed {points}/{total}\n")
