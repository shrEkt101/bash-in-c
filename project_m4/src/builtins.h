...
ssize_t external(char **tokens, size_t token_count);
 ...
 */
static const char * const BUILTINS[] = {"echo", "wc", "cat", "cd" "ls"};
static const bn_ptr BUILTINS_FN[] = {bn_echo, word_count, cat, cd, bn_ls, NULL};    // Extra null element for 'non-builtin'
